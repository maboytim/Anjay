...
static int cbor_get_some_bytes(anjay_input_ctx_t *ctx_,
...
static int
cbor_get_string(anjay_input_ctx_t *ctx_, char *out_buf, size_t buf_size) {
    assert(buf_size);
    cbor_in_t *ctx = (cbor_in_t *) ctx_;
...
static int cbor_get_integer(anjay_input_ctx_t *ctx_, int64_t *value) {
    cbor_in_t *ctx = (cbor_in_t *) ctx_;
...
static int cbor_get_uint(anjay_input_ctx_t *ctx_, uint64_t *value) {
    cbor_in_t *ctx = (cbor_in_t *) ctx_;
...
static int cbor_get_bool(anjay_input_ctx_t *ctx_, bool *value) {
    cbor_in_t *ctx = (cbor_in_t *) ctx_;
    anjay_json_like_value_type_t value_type;
    int result = _anjay_json_like_decoder_current_value_type(ctx->cbor_decoder,
                                                             &value_type);
...
static int cbor_get_double(anjay_input_ctx_t *ctx_, double *value) {
    cbor_in_t *ctx = (cbor_in_t *) ctx_;
...
static int cbor_get_objlnk(anjay_input_ctx_t *ctx_,
                           anjay_oid_t *out_oid,
                           anjay_iid_t *out_iid) {
...
static int cbor_in_close(anjay_input_ctx_t *ctx_) {
    cbor_in_t *ctx = (cbor_in_t *) ctx_;
    _anjay_json_like_decoder_delete(&ctx->cbor_decoder);
    return 0;
}

static int cbor_get_path(anjay_input_ctx_t *ctx,
...
static int cbor_next_entry(anjay_input_ctx_t *ctx) {
    (void) ctx;
    return 0;
}
...
int _anjay_input_cbor_create(anjay_input_ctx_t **out,
    ...
    *out = (anjay_input_ctx_t *) ctx;
    ...
    ctx->cbor_decoder = _anjay_cbor_decoder_new(*stream_ptr);
