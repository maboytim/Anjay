...
static int cbor_bytes_append(anjay_ret_bytes_ctx_t *ctx_,
                             const void *data,
                             size_t data_len) {
...
static int cbor_ret_bytes_begin(anjay_output_ctx_t *ctx_,
                                size_t length,
...
static int cbor_ret_string(anjay_output_ctx_t *ctx_, const char *value) {
    cbor_out_t *ctx = (cbor_out_t *) ctx_;
...
static int cbor_ret_integer(anjay_output_ctx_t *ctx_, int64_t value) {
    cbor_out_t *ctx = (cbor_out_t *) ctx_;
    if (ctx->bytes.num_bytes_left) {
        return -1;
    }
...
static int cbor_ret_uint(anjay_output_ctx_t *ctx_, uint64_t value) {
    cbor_out_t *ctx = (cbor_out_t *) ctx_;
    if (ctx->bytes.num_bytes_left) {
        return -1;
    }
...
static int cbor_ret_double(anjay_output_ctx_t *ctx_, double value) {
    cbor_out_t *ctx = (cbor_out_t *) ctx_;
    if (ctx->bytes.num_bytes_left) {
        return -1;
    }
...
static int cbor_ret_bool(anjay_output_ctx_t *ctx_, bool value) {
    cbor_out_t *ctx = (cbor_out_t *) ctx_;
    if (ctx->bytes.num_bytes_left) {
        return -1;
    }
...
static int
cbor_ret_objlnk(anjay_output_ctx_t *ctx_, anjay_oid_t oid, anjay_iid_t iid) {
...
static int cbor_set_path(anjay_output_ctx_t *ctx_,
...
static int cbor_clear_path(anjay_output_ctx_t *ctx_) {
    cbor_out_t *ctx = (cbor_out_t *) ctx_;
...
static int cbor_ret_close(anjay_output_ctx_t *ctx_) {
    cbor_out_t *ctx = (cbor_out_t *) ctx_;
    int result = 0;
...
anjay_output_ctx_t *_anjay_output_cbor_create(avs_stream_t *stream) {
